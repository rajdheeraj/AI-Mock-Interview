...
const s = {
  ...
  sideTop:           { display:'flex', alignItems:'center', justifyContent:'space-between', padding:'20px 16px 16px', borderBottom:'1px solid #1e293b' },
  brand:             { color:'#fff', fontWeight:'800', fontSize:'16px', whiteSpace:'nowrap' },
  ...
  sideFooter:        { marginTop:'auto', borderTop:'1px solid #1e293b', padding:'16px' },
  userRow:           { display:'flex', alignItems:'center', gap:'10px' },
  avatar:            { width:'36px', height:'36px', borderRadius:'50%', background:'linear-gradient(135deg,#3b82f6,#8b5cf6)', color:'#fff', display:'flex', alignItems:'center', justifyContent:'center', fontWeight:'700', fontSize:'15px', flexShrink:0 },
  userInfo:          { overflow:'hidden' },
  userName:          { color:'#e2e8f0', fontSize:'13px', fontWeight:'600', whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' },
  logoutBtn:         { background:'none', border:'none', color:'#ef4444', fontSize:'11px', cursor:'pointer', padding:0, marginTop:'2px' },
  main:              { flex:1, padding:'28px 32px', overflowY:'auto', display:'flex', flexDirection:'column' },
  topbar:            { display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:'28px' },
  greeting:          { fontSize:'26px', fontWeight:'800', color:'#0f172a', margin:'0 0 4px' },
  greetingSub:       { fontSize:'14px', color:'#64748b', margin:0 },
  topRight:          { display:'flex', alignItems:'center', gap:'12px' },
  searchBox:         { display:'flex', alignItems:'center', gap:'8px', background:'#fff', border:'1.5px solid #e2e8f0', borderRadius:'10px', padding:'9px 14px' },
  searchInput:       { border:'none', outline:'none', fontSize:'14px', color:'#334155', width:'180px', background:'transparent' },
  statsGrid:         { display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'16px', marginBottom:'32px' },
  statCard:          { background:'#fff', borderRadius:'14px', padding:'18px', display:'flex', alignItems:'center', gap:'14px', boxShadow:'0 1px 3px rgba(0,0,0,0.06)' },
  statIcon:          { width:'46px', height:'46px', borderRadius:'12px', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'20px', flexShrink:0 },
  statLabel:         { fontSize:'12px', color:'#64748b', marginBottom:'4px' },
  statVal:           { fontSize:'24px', fontWeight:'800' },
  sectionHeader:     { display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'16px' },
  sectionTitle:      { fontSize:'18px', fontWeight:'800', color:'#0f172a', margin:'0 0 2px' },
  sectionSub:        { fontSize:'13px', color:'#64748b', margin:0 },
  countBadge:        { padding:'4px 12px', background:'#eff6ff', color:'#3b82f6', borderRadius:'99px', fontSize:'12px', fontWeight:'600' },
  viewAllBtn:        { padding:'5px 14px', background:'#fff', border:'1.5px solid #3b82f6', color:'#3b82f6', borderRadius:'8px', fontSize:'12px', fontWeight:'600', cursor:'pointer' },
  filters:           { display:'flex', gap:'8px', marginBottom:'20px', flexWrap:'wrap' },
  pill:              { padding:'7px 18px', borderRadius:'99px', border:'1.5px solid #e2e8f0', background:'#fff', fontSize:'13px', color:'#475569', cursor:'pointer', fontWeight:'500' },
  pillActive:        { padding:'7px 18px', borderRadius:'99px', border:'1.5px solid #3b82f6', background:'#3b82f6', fontSize:'13px', color:'#fff', cursor:'pointer', fontWeight:'600' },
  cardsGrid:         { display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(210px,1fr))', gap:'16px', marginBottom:'36px' },
  card:              { background:'#fff', borderRadius:'16px', overflow:'hidden', border:'1px solid #f1f5f9', display:'flex', flexDirection:'column', transition:'transform 0.2s ease, box-shadow 0.2s ease', cursor:'pointer' },
  cardIconBox:       { padding:'20px 20px 14px', display:'flex', alignItems:'center', justifyContent:'space-between' },
  cardIcon:          { fontSize:'30px' },
  cardCategoryBadge: { fontSize:'10px', fontWeight:'700', padding:'3px 10px', borderRadius:'99px', letterSpacing:'0.3px' },
  cardBody:          { padding:'0 20px 14px', flex:1 },
  cardCompany:       { fontSize:'16px', fontWeight:'800', color:'#0f172a', margin:'0 0 4px' },
  cardRole:          { fontSize:'13px', color:'#64748b', margin:0 },
  cardFooter:        { padding:'0 16px 16px' },
  startBtn:          { width:'100%', padding:'10px', border:'none', borderRadius:'10px', fontSize:'13px', fontWeight:'700', cursor:'pointer', transition:'all 0.2s ease' },
  attemptList:       { background:'#fff', borderRadius:'14px', border:'1px solid #f1f5f9', overflow:'hidden', marginBottom:'24px' },
  tableHeader:       { display:'flex', padding:'11px 16px', background:'#f8fafc', borderBottom:'1px solid #f1f5f9', fontSize:'12px', fontWeight:'700', color:'#64748b', textTransform:'uppercase', letterSpacing:'0.5px' },
  tableRow:          { display:'flex', alignItems:'center', padding:'13px 16px', borderBottom:'1px solid #f8fafc', transition:'all 0.15s' },
  attemptAvatar:     { width:'32px', height:'32px', borderRadius:'8px', background:'linear-gradient(135deg,#3b82f6,#8b5cf6)', color:'#fff', display:'flex', alignItems:'center', justifyContent:'center', fontWeight:'700', fontSize:'13px', flexShrink:0 },
  attemptRole:       { fontSize:'14px', fontWeight:'600', color:'#0f172a' },
  attemptCompany:    { fontSize:'12px', color:'#64748b', marginTop:'2px' },
  categoryPill:      { fontSize:'11px', padding:'3px 10px', background:'#f1f5f9', color:'#475569', borderRadius:'99px', fontWeight:'500' },
  scorePill:         { fontSize:'13px', fontWeight:'700', padding:'3px 12px', borderRadius:'99px' },
  emptyState:        { textAlign:'center', padding:'56px 24px', background:'#fff', borderRadius:'14px', border:'1px solid #f1f5f9', marginBottom:'24px' },
  emptyIcon:         { fontSize:'44px', marginBottom:'14px' },
  emptyText:         { fontSize:'17px', fontWeight:'700', color:'#334155', margin:'0 0 6px' },
  emptySub:          { fontSize:'13px', color:'#94a3b8', margin:'0 0 20px' },
  emptyBtn:          { padding:'11px 24px', background:'#3b82f6', color:'#fff', border:'none', borderRadius:'10px', fontSize:'14px', fontWeight:'600', cursor:'pointer' },
  footer:            { textAlign:'center', padding:'20px', borderTop:'1px solid #e2e8f0', marginTop:'auto', fontSize:'12px', color:'#94a3b8' },
};